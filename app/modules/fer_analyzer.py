...
Uses Swin Transformer, CNN, and ViT ai_models for detecting emotions from facial expressions.
...
class FERAnalyzer:
    ...
    Uses multiple ai_models (Swin Transformer, Custom CNN) to analyze facial
